...
public class SceneGraph extends JPanel {
	...
	private SceneGraph.TransformedObject T1;
	private SceneGraph.TransformedObject T2;
	private SceneGraph.TransformedObject T3;
	private SceneGraph.TransformedObject R1;
	private SceneGraph.TransformedObject R2;
	private SceneGraph.TransformedObject R3;
	private SceneGraph.TransformedObject H1;
	private SceneGraph.TransformedObject H2;
	private SceneGraph.TransformedObject H3;
	private SceneGraph.TransformedObject H4;
	private SceneGraph.TransformedObject H5;
	private SceneGraph.TransformedObject H6;
	...
	private void createWorld() {
		...
		T1.setScale(0.9, 1.5).setTranslation(0, -2.3).setColor(Color.BLUE);
		world.add(T1);
		
		T2 = new TransformedObject((filledTriangle));
		T2.setScale(0.7, 1).setTranslation(-2.25, 0.5).setColor(new Color(128, 0, 128));
		world.add(T2);
		...
		R1.setRotation(-22.5).setScale(2, 0.1).setTranslation(0, -0.8).setColor(Color.RED);
		world.add(R1);
		
		R2 = new TransformedObject((filledRect));
		R2.setRotation(-22.5).setScale(1.8, 0.1).setTranslation(-2.2, 1.5).setColor(Color.RED);
		world.add(R2);
		
		R3 = new TransformedObject((filledRect));
		R3.setRotation(-22.5).setScale(1.5, 0.08).setTranslation(1.5, 1.8).setColor(Color.RED);
		world.add(R3);

		//Dodanie wielokąta
		H1 = new TransformedObject((heptagon));
		H1.setScale(0.3, 0.3).setTranslation(-0.889, -0.42);
		world.add(H1);
		
		H2 = new TransformedObject((heptagon));
		H2.setScale(0.3, 0.3).setTranslation(0.899, -1.189);
		world.add(H2);
		
		H3 = new TransformedObject((heptagon));
		H3.setScale(0.25, 0.25).setTranslation(-3, 1.825);
		world.add(H3);
		
		H4 = new TransformedObject((heptagon));
		H4.setScale(0.25, 0.25).setTranslation(-1.4, 1.18);
		world.add(H4);
		
		H5 = new TransformedObject((heptagon));
		H5.setScale(0.2, 0.2).setTranslation(0.83, 2.07);
		world.add(H5);

		H6 = new TransformedObject((heptagon));
	...
	private static SceneGraphNode heptagon = new SceneGraphNode()
	{
		void doDraw(Graphics2D g)
		{
			int n = 7;
			...
			for(int i = 0; i < n; i++)
			{
				x1[i] = (int) (280 * Math.sin(t));
				y1[i] = (int) (280 * Math.cos(t));
				t += k;
			}

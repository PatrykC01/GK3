...
RedLine(g2, 1, 1.05, 0, -0.5, Color.RED);

RedLine(g2, 0.85, 0.95, -2.65, 1.90, Color.RED);

RedLine(g2, 0.6, 0.70, 2.5, 2.5, Color.RED);
...
private void RedLine (Graphics2D g2, double skala_x, double skala_y, double translate_x, double translate_y, Color color)
...
private void rotatingPolygon(Graphics2D g2, double r, double translate_x, double translate_y) { // (DELETE THIS EXAMPLE)
